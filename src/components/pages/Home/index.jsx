...
import GlobalHighlights from '@/components/pages/Home/GlobalHighlights';
import Hero from '@/components/pages/Home/Hero';
import ProductSection from '@/components/pages/Home/ProductSection';
import {
  BUZZING_DESTINATIONS_DATA,
  FOR_YOU_DATA,
  GHANA_TOP_TEN_DATA,
  HOT_WEEK_DATA,
  SPOTLIGHT_DATA,
  ...
  return (
    <>
      ...
      <ProductSection
        items={HOT_WEEK_DATA}
        title="Hot This Week"
        className="lg:my-[106px] max-lg:my-14"
      />
      ...
      />
      <ProductSection
        items={BUZZING_DESTINATIONS_DATA}
        title="Buzzing Destinations"
        className="lg:my-[100px] max-lg:my-14"
