...
import { HIDDEN_GEMS_DATA } from '@/constants/data';

const DiscoverHiddenGems = () => {
  return (
    <section className="lg:my-[100px] max-lg:my-14">
