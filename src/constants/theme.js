...
export const hoverEffect = {
  after: 'after:absolute after:w-full after:left-0 after:top-0 after:bg-dark-50/80 after:transition-all after:duration-200 after:h-0 hover:after:h-full hover:text-accent-50'
}